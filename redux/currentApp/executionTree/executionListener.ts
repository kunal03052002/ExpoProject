...
import { styleActions } from "../style/cursorSlice"

export let executionTree: any | undefined
...
async function handleStartController(
  ...
  const compMap = getComponentMap(rootState)
  ...
  const subscriptions = [
    startListening({
      matcher: isAnyOf(
        ...
        styleActions.updateThemeReducer,
        styleActions.updateThemeNameReducer,
        styleActions.deleteStyleClassReducer,
        styleActions.updateClassNameReducer,
        styleActions.updateAppliedTheme
      ),
    ...
    startListening({
      matcher: isAnyOf(
        ...
        componentsActions.deleteSectionViewReducer,
        componentsActions.updateSectionViewPropsReducer,
        // componentsActions.addModalComponentReducer,updateTargetPageLayoutReducer
        componentsActions.setGlobalStateReducer,
        componentsActions.deleteGlobalStateByKeyReducer,
        componentsActions.deleteSubPageViewNodeReducer,
        componentsActions.updateDefaultSubPagePathReducer,
