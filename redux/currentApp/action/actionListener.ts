import { ActionContent, ActionItem } from "./interface"
...
import { AppListenerEffectAPI, AppStartListening, RootState } from "@/store"
...
const handleUpdateAsyncEffect = (
  ...
  const rootState:RootState = listenerApi.getState()
  ...
  const isGuideMode = getIsIMPAKTGuideMode(rootState)
