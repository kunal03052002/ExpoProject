...
import { getIsGridCanvas, getSelectedComponentDisplayNames } from "@/redux/config/configSelector"
...
export const PositionContainer: FC<PositionContainerProps> = (props) => {
  ...
  return (
    <div css={!isGridCanvas &&positionContainerStyle(x, y, isDragging, isSelected)}>
      {children}
    </div>
  )
}
