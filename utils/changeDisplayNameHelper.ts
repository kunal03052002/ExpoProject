...
import { getComponentMap, getRawTree } from "@/redux/currentApp/components/componentsSelector"
import { componentsActions } from "@/redux/currentApp/components/componentsSlice"
import {
  getInDependenciesMap,
} from "@/redux/currentApp/executionTree/executionSelector"
import { convertPathToString, hasDynamicStringSnippet } from "@/redux/utils"
import { isAction, isWidget } from "./executionTreeHelper/utils"
import { ComponentMapNode } from "./generators/interface"
...
const changeEventHandlerReferenceHelper = (
  ...
  actionLists.forEach((action) => {
    ...
    const { successEvent, failedEvent } = content as any
...
const mergeUpdateSlice = (
  ...
  const updateActionSliceMap: Record<string, any> = {}
