...
export const updateImpaktAppsMode: CaseReducer<
  ConfigState,
  PayloadAction<ImpaktMode>
> = (state, action) => {
...
export const updateLayoutSection: CaseReducer<
  ConfigState,
  PayloadAction<{ sectionName: string, value: "disable" | "active" }>
> = (state, action) => {
  state.layoutSectionState[action.payload.sectionName] = action.payload.value;
}
export const resetLayoutSection: CaseReducer<
  ConfigState,
  PayloadAction<Record<string, "disable" | "active"> | undefined
  >> = (state, action) => {
    state.layoutSectionState = action.payload || { body: "active", "other": "disable" };
  }
export const updateStylePanel: CaseReducer<
  ConfigState,
  PayloadAction<boolean>
> = (state, action) => {
  state.openStylePanel = action.payload
}
export const updateThemePanel: CaseReducer<
  ConfigState, PayloadAction<boolean>
> = (state, action) => {
  state.openThemePanel = action.payload;
}
export const updateScreenPanel: CaseReducer<
  ConfigState, PayloadAction<boolean>
> = (state, action) => {
  state.openScreenPanel = action.payload;
}
...
export const updateSelectedThemePanel: CaseReducer<
  ConfigState,
  PayloadAction<string>
> = (state, action) => {

  state.selectedThemePanel = action.payload
}

export const updateSelectedClass: CaseReducer<
  ConfigState,
  PayloadAction<string>
> = (state, action) => {
...
export const updateSelectedScreen: CaseReducer<
  ConfigState,
  PayloadAction<"Mobile" | "Tablet" | "Desktop">
> = (state, action) => {
...
> = (state, action) => {
  const cachedAction: any = state.cachedAction
...
export const updateGridContainer: CaseReducer<ConfigState, PayloadAction<boolean>> = (
  state,
  action,
) => {
  state.gridCanvas = action.payload
}
