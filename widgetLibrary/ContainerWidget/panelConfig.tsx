...
import RadioIcon from "@/assets/radius-icon.svg"
import i18n from "@/i18n/config"
import { VALIDATION_TYPES } from "@/utils/validationFactory"

const baseWidgetName = "Container"
export const CONTAINER_PANEL_CONFIG: any[] = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        childrenSetter: [
          ...
          {
            id: `${baseWidgetName}-style-classes`,
            labelName: "Select True CSS Classes  :",
            isSetterSingleRow:true,
            attrName: "trueClasses",
