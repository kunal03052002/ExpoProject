...
import { useMergeValue } from "../DropDown/use-merge-value";
import { isFunction } from "util";
import Select from "@mui/material/Select";
import { MenuItem } from "@mui/material";
import { deleteCssProps } from "../model/src";
        ...
        <>
          {!!sizeCanChange && (
            <Select
             size="small"
              disabled={disabled}
              sx={{ ml: "8px", color: inputBorderColorScheme }}
