...
const buildSessionTypeMapComponentConfig = ():WidgetConfig[] => {
...
export const buildComponentList = ():WidgetConfig[]  => {
...
//   return keys.map((key) => {
    ...
    // {
    //   title:"Act21",
    // //    sessionTypeMapSessionNameKey[key],
