...
import { ActionContent } from "@/redux/currentApp/action/interface"
import { getNewWidgetPropsByUpdateSlice } from "@/redux/utils"
import { isObject } from "@/utils/evaluateDynamicString/valueConverter"
import { TriggerProvider } from "@/utils/trigger/trigger-provider"

export const ActionEventHandler: FC = () => {
  const { t } = useTranslation()
  const action:any = useSelector(getCachedAction)
