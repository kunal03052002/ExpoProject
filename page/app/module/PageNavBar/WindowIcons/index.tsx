...
import {ReactComponent as WindowRightIcon } from '@assets/window-right.svg';
import {ReactComponent as WindowLeftIcon} from '@assets/window-left.svg';
import {ReactComponent as WindowBottomIcon} from '@assets/window-bottom.svg';
import {
  isOpenBottomPanel,
  isOpenLeftPanel,
  isOpenRightPanel,
  ...
  return (
    ...
    >
      <span css={windowIconBodyStyle} onClick={handleClickLeftWindowIcon}>
        <WindowLeftIcon css={windowIconStyle(leftPanelVisible)} />
      </span>
      <span css={windowIconBodyStyle} onClick={handleClickBottomWindowIcon}>
        <WindowBottomIcon css={windowIconStyle(bottomPanelVisible)} />
      </span>
      <span css={windowIconBodyStyle} onClick={handleClickRightWindowIcon}>
        <WindowRightIcon css={windowIconStyle(rightPanelVisible)} />
      </span>
    </div>
  )
}
