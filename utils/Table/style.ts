...
export function applyBorderStyle(
  ...
  if (borderCell) {
    if (lastCol) {
      ...
      borderStyle = css`
        border-right: solid 1px ${globalColor(`grayBlue-08`)};
      `
    }
  }
  ...
  if (striped) {
    stripedStyle = css`
      border-bottom: solid 1px ${globalColor(`grayBlue-08`)};
    `
  }
...
export function applyTdSelectedStyle(selected?: boolean) {
  ...
  return css`
    box-shadow: inset 0 0 0 1px ${globalColor(`blue-03`)};
  `
}
...
export function applyBgHoverStyle(hoverable?: boolean): SerializedStyles {
  const hoverableStyle = css`
    &:hover {
      background-color: ${chroma(globalColor(`grayBlue-09`))
        .alpha(0.5)
        .hex()};
    }
  `
...
export function applySelectedStyle(selected?: boolean): SerializedStyles {
  ...
  return css`
    background-color: ${globalColor(`blue-08`)};
...
export const applyOverflowContentStyle = (
  ...
  return css`
    ...
    border: solid 1px ${globalColor(`blue-03`)};
    box-sizing: border-box;
  `
}
...
export function applyBorderedStyle(bordered?: boolean): SerializedStyles {
  return bordered
    ? css`
        border: solid 1px ${globalColor(`grayBlue-08`)};
      `
    : css``
}
...
export const tableResizerStyle = css`
  ...
  &:hover {
    &:after {
      ...
      bottom: 0;
      right: 3px;
      background-color: ${globalColor(`grayBlue-06`)};
      width: 1px;
    }
  }
`
